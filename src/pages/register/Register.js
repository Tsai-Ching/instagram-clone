		...
		<div className='register-container'>
			<main className='container flex flex-row justify-center items-center'>
				...
				<div className="pa4 black-80 flex flex-column register-form-container">
					<form class="w-100 center register-form" onSubmit={registerUser}>
					    <fieldset id="sign_up" class="ba b--transparent ph0 mh0">
						    <div className="brand-logo tc">
						    	<i className="fa-brands fa-instagram fa-6x"></i>
						    	<h5 className='gray b ma3 description'>註冊即可查看朋友的相片和影片。</h5>
						    </div>
						    <div className="input-area">
							    ...
							    <p className='gray w-80 center tc ma3 description'>註冊即表示你同意我們的服務條款、《隱私政策》和《Cookie 政策》。</p>
							    <div className="mv3 tc">
							      	<input class="send ma3 f4 tc w-80 pv3 bg-animate bg-blue hover-bg-dark-blue white br2" 
									    type="submit" 
									    value="註冊" 
							      	/>
							    </div>
